            ...
            <div className="px-4 md:px-10 lg:px-40 flex flex-1 justify-center">
              <div className="layout-content-container flex flex-col max-w-[1280px] flex-1">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 px-4">
                  <div className="flex flex-col items-center md:items-start p-8 bg-background-dark rounded-xl border border-border-dark hover:border-primary transition-colors group min-w-0">
                    ...
                    <h3 className="text-gray-400 font-bold mb-3 text-sm uppercase tracking-wide text-center md:text-left">Consultor</h3>
                    <p className="text-white text-base md:text-lg font-bold text-center md:text-left">Ing. Roberto Andrade Fonseca</p>
                  </div>
                  ...
                  <div className="flex flex-col items-center md:items-start p-8 bg-background-dark rounded-xl border border-border-dark hover:border-primary transition-colors group min-w-0">
                    ...
                    <h3 className="text-gray-400 font-bold mb-3 text-sm uppercase tracking-wide text-center md:text-left">Teléfono</h3>
                    <p className="text-white text-base md:text-lg font-bold text-center md:text-left">
                      55 25765962
                    </p>
                  </div>
