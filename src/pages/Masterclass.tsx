...
const AGENDA = [
  ...
  { tiempo: '50–70 min', titulo: 'Demo 3 · Industrial 🏭', texto: 'Cotizaciones en PDF, monitoreo de proveedores, alertas y hasta el sitio web con funnel de marketing.' },
...
const CASOS = [
  {
    ...
    momentos: [
      'Paciente pide cita → el agente consulta la agenda, propone horarios libres, confirma y envía dirección + indicaciones de llegada',
      '24 h antes → recordatorio automático y confirmación de asistencia',
      '"¿A qué hora era mi cita?" → responde al instante, a cualquier hora',
      'Antes de la consulta → entrega al doctor un resumen del historial del paciente',
    ],
    reality: 'El agente elimina el trámite, no la decisión clínica. En el diagnóstico calibras exactamente qué sí puede hacer un agente y qué no.',
    canal: 'WhatsApp · Telegram · Email',
  },
  {
    icono: 'storefront',
    etiqueta: 'Demo 2 · Comercio',
    titulo: 'Laura, comerciante',
    dolor: 'Vende por Instagram y WhatsApp, y pierde ventas porque no da abasto para responder.',
    momentos: [
      'Cliente pregunta disponibilidad → el agente consulta inventario en tiempo real y responde',
      'Cliente confirma → genera la orden, notifica a Laura y confirma la compra',
      'Lead dormido de 3 días ("lo veo y te digo") → reactivación con mensaje personalizado',
      'Promoción aprobada → se distribuye a los clientes frecuentes de esa categoría',
    ],
    reality: 'El agente lee el inventario y da seguimiento, pero no inventa promociones sin tu autorización.',
  ...
  },
  {
    ...
    dolor: 'Empresa de tamaño medio que resuelve retos industriales complejos para grandes empresas — y además necesita un frente comercial: sitio web y funnel que atraigan clientes solos.',
    momentos: [
      'Cliente pide cotización → el agente busca precios, genera el PDF y lo envía',
      'Cada mañana → resumen de precios de 3 proveedores',
      'Un proveedor sube precio más del 5% → alerta con alternativas',
      'Mantenimiento preventivo → recuerda registrar el servicio de cada equipo',
      'Construye y actualiza el sitio web y opera el funnel: landing de soluciones → captura de leads → seguimiento automático',
    ],
    reality: 'Trabaja con los datos que le das, y el sitio se construye con tu contenido y tu marca. La estrategia — qué ofrecer, a quién, con qué mensaje — se define contigo.',
...
const DOLARES = [
  ...
  { icono: 'precision_manufacturing', titulo: '¿Aún haces cotizaciones a mano mientras el proyecto espera?', texto: 'Y el sitio web y el embudo de ventas siguen sin actualizarse porque "no hay tiempo".' },
]
...
const FAQS = [
  ...
  { q: 'Mi negocio no es de los tres casos que mencionas. ¿Aún me sirve?', a: 'Sí. Las tres demos usan las mismas cuatro capacidades base: atención al cliente multicanal, agenda y seguimiento, documentos, y monitoreo con alertas. Casi todo negocio de servicios o de caja las toca en su operación diaria.' },
